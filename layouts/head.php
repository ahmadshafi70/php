...
<head>
	...
	<title><?php if(isset($_SESSION)){echo $_SESSION["title"];}
        else {
           } ?> </title>
	<meta name="description" content="<?php if(isset($_SESSION)){echo $_SESSION["title"];}
        else {
          }?>">
    <?php if(isset($_SESSION)){echo $_SESSION["robots"];}
        else {
          }?>
...
<?php if(isset($_SESSION)){echo $_SESSION["code"];}
        else {
          }?>
</head>